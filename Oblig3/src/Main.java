...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(planetSystem.getPlanetByName("Jupiter"));
        ...
        System.out.println();
        System.out.println(earth.orbitingVelocity(earth.distanceToCentralBody(0)));
        System.out.println(earth.orbitingVelocity(earth.distanceToCentralBody(45)));
        System.out.println(earth.orbitingVelocity(earth.distanceToCentralBody(90)));
        System.out.println(earth.orbitingVelocity(earth.distanceToCentralBody(135)));
        System.out.println(earth.orbitingVelocity(earth.distanceToCentralBody(180)));
    }
}